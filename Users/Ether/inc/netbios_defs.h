...
#define SMB_PACKED_START	_ALIGN1_
#define SMB_PACKED_END
...
#define NETBIOS_FLAG_AUTHOR		(1 << 10)
#define NETBIOS_FLAG_TRUNCATED  (1 << 9)
#define NETBIOS_FLAG_RECURSIVE  (1 << 8)
#define NETBIOS_FLAG_BROADCAST  (1 << 4)

// Name Service Query
#define NETBIOS_OP_NAME_QUERY         0x0000
#define NETBIOS_OP_REG_QUERY		  0x2800
#define NETBIOS_OP_REL_QUERY		  0x3000
#define NETBIOS_OP_WACK_QUERY		  0x3800
#define NETBIOS_OP_REFRESH_QUERY	  0x4000
// Session Service
...
#define ntohs(x)	end_swap16(x)
#define htons(x)	end_swap16(x)
