...
#include "..\..\inc\usb\usbreg.h"
#include "..\..\inc\usb\usbhw.h"
#include "..\..\inc\usb\usbuser.h"
...
void USB_Init (void) {
	...
	//NVIC->ISER[0] |= (1 << (CAN1_RX0_IRQn & 0x1F));
	...
	//RCC_APB2PeriphClockCmd(RCC_APB2Periph_SYSCFG, ENABLE);		//AFIO replaced with SYSCFG on F407
	RCC_AHB2PeriphClockCmd(RCC_AHB2Periph_OTG_FS, ENABLE);
	NVIC_EnableIRQ(CAN1_RX0_IRQn);
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource11, GPIO_AF_OTG_FS);			//
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource12, GPIO_AF_OTG_FS);			//
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;	//pin 2
  	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;			//peripheral (alternate function push pull)	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11 | GPIO_Pin_12;	//pin 2
  	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;			//peripheral (alternate function push pull)	
